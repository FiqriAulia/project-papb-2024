...
public class Friendlistfoto extends AppCompatActivity {
    ...
    private void fetchData() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RvAdapter rvAdapter = new RvAdapter(Friendlistfoto.this, data, new RvInteface() {
                    @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(Friendlistfoto.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
            }
        });
    }
