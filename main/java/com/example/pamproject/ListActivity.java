...
public class ListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendImageButton.setOnClickListener(view -> sendImageToSelectedContacts());
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                // Tidak perlu melakukan apapun saat submit
                return false;
            }

            @Override
            public boolean onQueryTextChange(String newText) {
                kontakAdapter.filter(newText); // Panggil metode filter di adapter
                return false;
            }
        });
    }
    ...
    private void initView() {
        ...
        RecyclerView.LayoutManager lm = new LinearLayoutManager(ListActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void sendImageToSelectedContacts() {
        ...
        if (imageFilePath != null && !imageFilePath.isEmpty()) {
            ...
            if (imageFile.exists()) {
                uploadImageToFirebase(imageFile, uploadDate, status, selectedContacts);
            } else {
